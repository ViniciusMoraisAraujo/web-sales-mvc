...
namespace WebSales.Data
{
    public class SeedingService
    {
        ...
        public void Seed() 
        {
            ...
            Seller s2 = new Seller(2, "Junin", "junin@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Luiza", "luiza@gmail.com", new DateTime(2000, 4, 10), 2200.0, d1);
            Seller s4 = new Seller(4, "Koda", "koda@gmail.com", new DateTime(1997, 3, 11), 3000.0, d4);
            Seller s5 = new Seller(5, "Lola", "Lola@gmail.com", new DateTime(2001, 10, 1), 4000.0, d3);
            Seller s6 = new Seller(6, "Vinicim", "vinicim@gmail.com", new DateTime(2002, 3, 27), 3000.0, d2);

            SalesRecord r1 = new SalesRecord(1, new DateTime(201, 09, 25), 11000.0, Models.Enums.SaleStatus.Billed, s1);
